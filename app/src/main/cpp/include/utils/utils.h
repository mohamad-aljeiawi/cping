...
namespace Utils
{
    ...
    void advanced_health_bar(ImDrawList *draw_list, float x, float y, float width, float height, float health, float max_health, ImU32 color, ImU32 background_color, float distance, int teamId);
}
