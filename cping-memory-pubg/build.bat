...
adb push "C:/Users/mohamadaljeiawi/Desktop/cping/cping-memory-pubg/libs/arm64-v8a/cping_memory_pubg" "/data/local/tmp/"
if %ERRORLEVEL% NEQ 0 (
    echo Push failed!
    pause
    exit /b 1
...
adb shell su -c "chmod 755 /data/local/tmp/cping_memory_pubg"
...
:: Run cping_memory_pubg
echo Starting cping_memory_pubg...
